    ...
    methods: {
        ...
        async getSelectedRegionsCommunes() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.get(
                    "https://paneldecontrolaprende.cl/api/content_commune/" + this.$route.params.id,
                    {
                        headers: {
                        accept: "application/json",
                        Authorization: `Bearer ${token}`,
            ...
            if(token) {
                ...
                try {
                    const response = await axios.post(
                        "https://paneldecontrolaprende.cl/api/content/" + this.$route.params.id,
                        formData,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
        ...
        async getData() {
            ...
            if(token) {
                ...
                try {
                    const response = await axios.get(
                        "https://paneldecontrolaprende.cl/api/content_region/" + this.$route.params.id,
                        {
                            headers: {
                                accept: "application/json",
                                Authorization: `Bearer ${token}`,
