    ...
    methods: {
            ...
            if (token) {
                try {
                    const response = await axios.post(
                        "https://paneldecontrolaprende.cl/api/get_all",
                        {
                            headers: {
        ...
        async submit() {
            ...
            if (token) {
                ...
                try {
                    const response = await axios.post(
                        "https://paneldecontrolaprende.cl/api/user/" + this.$route.params.id,
                        formData,
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
        ...
        async getData() {
            ...
            if(token) {
                try {
                    const response = await axios.get("https://paneldecontrolaprende.cl/api/user/" + this.$route.params.id, {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
                    });
